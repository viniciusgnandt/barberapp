...
import {
  ...
  RefreshCw, Filter, Wallet, Store, Award, FileSpreadsheet,
} from 'lucide-react';
      ...
      {cur && !loading && (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {/* Monthly chart (year/quarter presets) */}
  ...
  return (
    <div className="space-y-6 animate-fade-up">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        {/* Export dropdown */}
        {((data && activeTab !== 'stock' && activeTab !== 'business') || (stockPDF && activeTab === 'stock')) && (
      ...
      <div className="flex gap-1 bg-gray-100 dark:bg-gray-800/80 rounded-xl p-1 w-fit border border-gray-200/60 dark:border-gray-700/40">
        {[
          ...
          { id: 'financial', label: 'Gestão Financeira', icon: DollarSign, adminOnly: false },
          { id: 'business',  label: 'Meu Negócio',       icon: TrendingUp, adminOnly: false },
          { id: 'stock',     label: 'Estoque',           icon: Package,    adminOnly: true  },
      ...
      {/* Filters + empty state — hidden on stock/business tabs (they have their own) */}
      {activeTab !== 'stock' && activeTab !== 'business' && (
        <>
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 shadow-sm">
            <div className="flex flex-wrap gap-3 items-end">
              <div className="space-y-1">
